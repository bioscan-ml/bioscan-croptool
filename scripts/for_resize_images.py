...
if __name__ == '__main__':
    ...
    for tarfile_name in pbar:
        ...
        # Unzip tar file to the target folder. Remove the tar file.
        ...
        os.system("find " + input_folder_dir + " -name '*.jpg' -exec bash -c 'convert ${0} -resize x256 " + resize_folder_dir + "-256/${0##*/}' {} \;")
